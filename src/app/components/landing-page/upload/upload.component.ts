          ...
          data: {
            ...
            content: `
              <div class="flex flex-col items-center justify-center py-4">
                <img src="assets/animations/ScriptBot_Animation-BW.gif" alt="Processing..." class="w-48 h-48 mb-4">
                <div class="text-center max-w-md">
                  <h3 class="text-lg font-semibold text-indigo-700 mb-2">Processing Your Document</h3>
                  <div class="mb-4">
                    <p class="text-sm text-gray-500 mb-1" id="step-info">Step <span id="current-step">1</span> of <span id="total-steps">15</span></p>
                    <p class="text-gray-700 font-medium" id="progress-message">Uploading your document...</p>
                  </div>
                  <div class="w-full bg-gray-200 rounded-full h-3 mb-4">
                    <div class="bg-gradient-to-r from-indigo-500 to-indigo-600 h-3 rounded-full transition-all duration-500" id="progress-bar" style="width: 0%"></div>
                  </div>
        ...
        this.scanProgressSubscription = this.upload.scanProgress$.subscribe(progress => {
          if (progress) {
            ...
            setTimeout(() => {
              ...
              if (currentStep && progress.step) {
                currentStep.textContent = progress.step.toString();
              }

              if (totalSteps && progress.totalSteps) {
                totalSteps.textContent = progress.totalSteps.toString();
              }
            });
          }
        });
