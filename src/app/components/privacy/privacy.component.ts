...
export class PrivacyComponent {
  ...
  readonly sections: LegalSection[] = [
    ...
    {
      id: 'how-your-content-is-handled',
      title: '3. How your content is handled',
      paragraphs: [
        'Your uploaded content is processed to provide the Service for your account. We aim to limit ' +
        'access to what is needed to operate the Service. You are responsible for the rights to the ' +
        'content you upload (see the Terms of Service). If you delete a document, we remove it from ' +
        'the active Service; copies in routine backups age out over time.'
      ]
    },
    {
      id: 'sharing',
      title: '4. Sharing',
      paragraphs: [
        'We share information only with service providers that help us run the Service (such as ' +
        'hosting, PDF generation, and payment processing), and only as needed for them to perform ' +
        'those functions. We may disclose information if required by law or to protect our rights, ' +
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'provide the Service. You can request deletion of your documents or account by contacting ' +
        'sideswaysscriptsides@gmail.com. Once deleted, content should be treated as unrecoverable.'
      ]
    },
    {
      id: 'security',
      ...
      paragraphs: [
        ...
        'transmission over secure (HTTPS/TLS) connections. However, no method of transmission or ' +
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'example, to keep you signed in). You can control cookies through your browser settings, ' +
    ...
    },
    {
      ...
      paragraphs: [
        'We may update this Policy from time to time. We will update the effective date and, where ' +
        'appropriate, provide notice. Continued use after changes take effect means you accept the ' +
        'updated Policy.'
      ]
    },
    {
      id: 'contact',
      title: '10. Contact',
      paragraphs: ['Questions about this Policy or your data? Email sideswaysscriptsides@gmail.com.']
    }
  ];
